...
add_types = {}
msgs_folder = Path("/home/alistair/dev/repos/QUTMS_Driverless/src/common/custom_sys_msgs/msg")
add_types.update(get_types_from_msg((msgs_folder / "Cone.msg").read_text(), "custom_sys_msgs/msg/Cone"))
add_types.update(
    get_types_from_msg((msgs_folder / "ConeWithCovariance.msg").read_text(), "custom_sys_msgs/msg/ConeWithCovariance")
)
add_types.update(
    get_types_from_msg(
        (msgs_folder / "ConeDetectionStamped.msg").read_text(), "custom_sys_msgs/msg/ConeDetectionStamped"
    )
)
